...
dependencies {
    ...
    implementation("com.github.TakWolf.Android-HeaderAndFooterRecyclerView:hfrecyclerview:0.0.10")
    // 可选。分页组件。
    implementation("com.github.TakWolf.Android-HeaderAndFooterRecyclerView:paging:0.0.10")
}
```
